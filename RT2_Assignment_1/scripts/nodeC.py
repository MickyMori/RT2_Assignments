...
def callback(sub_data):
	"""
	Callback function that computes the distance from the goal and the speed of the robot
...
def main():
	"""
	Main function that initializes the node, the publisher and the subscriber
	"""
	global data	
	#initialize the node
